...
public:
	...
	VulkanPushBuffer(VulkanContext *vulkan, size_t size, VkMemoryPropertyFlags memoryPropertyMask = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT);
	~VulkanPushBuffer();
